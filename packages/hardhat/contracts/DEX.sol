...
contract DEX {
     ...
     */
    event EthToTokenSwap(address indexed sender, string description, uint256 ethInput, uint256 tokenOutput);

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address indexed sender, string description, uint256 ethOutput, uint256 tokenInput);

    /**
     * @notice Emitted when liquidity provided to DEX and mints LPTs.
     */
    event LiquidityProvided(address indexed sender, uint256 liquidityMinted, uint256 ethDeposited, uint256 tokensDeposited);

    /**
     * @notice Emitted when liquidity removed from DEX and decreases LPT count within DEX.
     */
    event LiquidityRemoved(address indexed sender, uint256 amount, uint256 eth_amount, uint256 token_amount);

    event Approval(address indexed sender, address recipent, uint256 tokenInput);
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        emit Approval(msg.sender, address(this), tokenInput);
        return ethOutput;
    }
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        emit Approval(msg.sender, address(this), tokensDeposited);
